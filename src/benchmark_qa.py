...
if __name__ == "__main__":
    ...
    #     print(f"Iteration {i}")
    #     benchmark_problem_sizes(
    #         [ {"n": n, "p": 0.4, "k": er_max_clique_size(n, 0.4)-1, "iters_per_graph" : 1, "B": B, "T":20} for B in [2, 3, 3.5, 4, 4.5, 5] for n in [6, 8, 10, 12]],
    #         "qa_qutip_results_kclique_b_n5.json",
    #         problem=qa_k_clique_bqm,
    #         validate_solutions=helper_validate_k_clique_solutions,
    #         instance_generator=generate_k_clique_instance,
    #         num_graphs=60,
    ...
    #     print(f"Iteration {i}")
    #     benchmark_problem_sizes(
    #         [ {"n": 8, "p": 0.4, "k": er_max_clique_size(8, 0.4)-1, "iters_per_graph" : 1, "B": 2, "T": T} for T in [50, 100]],
    #         "qa_qutip_results_kclique_T4.json",
    #         problem=qa_k_clique_bqm,
    #         validate_solutions=helper_validate_k_clique_solutions,
    #         instance_generator=generate_k_clique_instance,
    #         num_graphs=12,
    ...
    # test qa on finding k-clique, eigenenergies
    # benchmark_problem_sizes(
    #     [ {"n": 9, "p": 0.4, "k": er_max_clique_size(9, 0.4)-1, "iters_per_graph" : 1, "B": 2, "T": 4, "steps": 50}],
    #     "qa_qutip_results_kclique_eigen.json",
    #     problem=qa_k_clique_bqm,
    #     validate_solutions=helper_validate_k_clique_solutions,
    #     instance_generator=generate_k_clique_instance,
    #     num_graphs=1,
    ...
    #         [ {"n": int(n), "p": 0.4, "k": None, "iters_per_graph" : 4, "B": float(b)} for b in [2, 3, 4, 6, 8] for n in [6, 8, 10, 12]],
    #         "qa_qutip_results_maxclique_n_b2.json",
    #         problem=qa_max_clique_bqm,
    #         validate_solutions=helper_validate_max_clique_solutions,
    #         instance_generator=generate_random_graph_instance,
    #         num_graphs=24,
